class Currencies {
  static const symbolKey = "symbol";

  static Map<String, Map<String, dynamic>> all = {
    "CAD": {
      symbolKey: "\$",
    },
    "EUR": {
  ...
  // List from https://github.com/Daniel-Ioannou/flutter_currency_picker
  static List<Map<String, dynamic>> allOld = [
    {
      "code": "USD",
