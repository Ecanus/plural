...
void main() {
  group("AskDialogEditForm test", () {
    testWidgets("widgets", (tester) async {
            ...
            body: Builder(
              builder: (BuildContext context) {
                return ElevatedButton(
                  onPressed: () => createEditableAskDialog(context: context, ask: tc.ask),
      ...
      expect(find.byType(AskDialogEditForm), findsNothing);
      ...
      expect(find.byType(AskDialogEditForm), findsOneWidget);
